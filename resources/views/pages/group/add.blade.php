            ...
            <div class="col-lg-6 offset-lg-3 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('groupStore') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="begin"  min="1900" max="2099" class="form-control {{ $errors->has('begin') ? "is-invalid":"" }}" value="{{ old('begin') }}" required>
                                @if($errors->has('begin'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"  min="1900" max="2099" name="end" class="form-control {{ $errors->has('end') ? "is-invalid":"" }}" value="{{ old('end') }}" required>
                                @if($errors->has('end'))
